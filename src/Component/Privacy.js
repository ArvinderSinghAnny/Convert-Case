   ...
   return (
      <>
         <div class="container-fluid my-5">
            <h1>Privacy Policy for mycaseconverter</h1>
            <br></br>

            <p>
               At mycaseconverter, accessible from mycaseconverter.com, one of our main
               priorities is the privacy of our visitors. This Privacy Policy document
               contains types of information that is collected and recorded by
               mycaseconverter and how we use it.
            </p>
            ...
            <p>
               mycaseconverter follows a standard procedure of using log files. These
            ...
            <p>
               Like any other website, mycaseconverter uses 'cookies'. These cookies are
               used to store information including visitors' preferences, and the pages on
               the website that the visitor accessed or visited. The information is used
            ...
            <p>
               ...
               their own Privacy Policy for their policies on user data. For easier
            ...
            <p>
               ...
               advertising partners of mycaseconverter.
            </p>

            <p>
               Third-party ad servers or ad networks uses technologies like cookies,
               JavaScript, or Web Beacons that are used in their respective advertisements
               and links that appear on mycaseconverter, which are sent directly to users'
            ...
            <p>
               Note that mycaseconverter has no access to or control over these cookies
            ...
            <p>
               mycaseconverter's Privacy Policy does not apply to other advertisers or
            ...
            <p>
               mycaseconverter does not knowingly collect any Personal Identifiable
            ...
            <p>
               ...
               and/or collect in mycaseconverter. This policy is not applicable to any
