...
export default function About() {
   ...
   return (
      <>
         <h3>About</h3>
         <div className="accordion " id="accordionExample" style={setStyle}>
            ...
            <div className="accordion-item">
               <h2 className="accordion-header" id="headingTwo" style={setStyle}>
                  <button
         ...
         <div className="container my-3">
            <button className="btn btn-primary" onClick={clickk}>
               Enable Dark Mode
            </button>
            <button className="btn btn-primary" onClick={clickk}>
               Enable Light Mode
