...
export default function Desc() {
   return (
      <div class="container-fluid my-5">
         <h1>Disclaimer for Mycaseconverter</h1>
         <br></br>

         <p>
            If you require any more information or have any questions about our site's
            disclaimer, please feel free to contact us by email at arvindersingh5577@gmail.com
         </p>

         <h2>Disclaimers for Mycaseconverter</h2>

         <p>
            All the information on this website - mycaseconverter.com - is published in
            good faith and for general information purpose only. Mycaseconverter does not
            ...
            (Mycaseconverter), is strictly at your own risk. Mycaseconverter will not be
         ...
         <p>
            ...
            notice and may occur before we have the opportunity to remove a link which may
            have gone 'bad'.
         </p>
