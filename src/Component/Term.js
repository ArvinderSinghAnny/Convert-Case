...
export default function Term() {
   return (
      <div class="container-fluid my-5">
         ...
         <br></br>
         <p>Welcome to mycaseconverter!</p>

         <p>
            These terms and conditions outline the rules and regulations for the use of
            mycaseconverter's Website, located at mycaseconverter.com.
         </p>

         <p>
            By accessing this website we assume you accept these terms and conditions. Do
            not continue to use mycaseconverter if you do not agree to take all of the
         ...
         <p>
            We employ the use of cookies. By accessing mycaseconverter, you agreed to use
            cookies in agreement with the mycaseconverter's Privacy Policy.{" "}
         </p>
         ...
         <p>
            Unless otherwise stated, mycaseconverter and/or its licensors own the
            intellectual property rights for all material on mycaseconverter. All
            intellectual property rights are reserved. You may access this from
            mycaseconverter for your own personal use subjected to restrictions set in
            these terms and conditions.
         </p>

         <p>You must not:</p>
         <ul>
            <li>Republish material from mycaseconverter</li>
            <li>Sell, rent or sub-license material from mycaseconverter</li>
            <li>Reproduce, duplicate or copy material from mycaseconverter</li>
            <li>Redistribute content from mycaseconverter</li>
         </ul>
         ...
         <p>
            ...
            opinions and information in certain areas of the website. mycaseconverter does
            not filter, edit, publish or review Comments prior to their presence on the
            website. Comments do not reflect the views and opinions of mycaseconverter,its
            ...
            applicable laws, mycaseconverter shall not be liable for the Comments or for
         ...
         <p>
            mycaseconverter reserves the right to monitor all Comments and to remove any
         ...
         <p>
            You hereby grant mycaseconverter a non-exclusive license to use, reproduce,
         ...
         <p>
            ...
            absence of mycaseconverter; and (d) the link is in the context of general
         ...
         <p>
            ...
            to mycaseconverter. Please include your name, your organization name, contact
         ...
         <p>
            No use of mycaseconverter's logo or other artwork will be allowed for linking
